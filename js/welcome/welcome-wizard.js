...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('back-cover-image-input').addEventListener('change', function (event) {
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                ...
                document.querySelector('.book-preview-3d .back').style.backgroundImage = `url(${imageUrl})`;
                document.querySelector('.book-preview-3d .back').style.backgroundColor = 'transparent';
    ...
    frontCoverRadio.addEventListener('change', function () {
        if (this.checked) {
            document.querySelector('.book-preview-3d').classList.remove('flip');
    ...
    backCoverRadio.addEventListener('change', function () {
        if (this.checked) {
            document.querySelector('.book-preview-3d').classList.add('flip');
    ...
    function saveBookDataToLocalStorage() {
        ...
        console.log('Datos del asistente guardados en sessionStorage, pageCount:', window.bookData.pageCount);
    }
